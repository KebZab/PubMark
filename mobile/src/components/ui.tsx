...
const STATUS_STYLES: Record<ApplicationStatus | "terminated", { bg: string; text: string; label: string }> = {
...
export function StatusPill({ status }: { status: ApplicationStatus | "terminated" }) {
