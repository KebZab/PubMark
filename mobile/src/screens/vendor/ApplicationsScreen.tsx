...
import { Card, EmptyState, ErrorState, LoadingState, ScreenHeader, StatusPill, formatDate } from "../../components/ui";
            ...
            {shown.map((app) => (
              <Card key={app.id} className="p-4">
                ...
                <View className="mt-3 border-t border-gray-100 pt-3">
                  ...
                  <Row label="Contract" value={`${formatDate(app.contractStart)} → ${formatDate(app.contractEnd)}`} />
