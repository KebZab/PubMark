...
export default function ApplicationDetailScreen({ route, navigation }: any) {
  const initial = route.params.application as Application;
  ...
  const attachPermit = async (fileName: string) => {
    setBusy(true);
    try {
        ...
        <View className="flex-1 justify-center bg-black/50 px-6">
          <View className="rounded-2xl bg-white p-5">
            ...
            <Text className="mt-1 text-xs leading-5 text-gray-500">
              Enter the email of the vendor who should receive this stall. They must already have a
              PubMark account.
            </Text>
            ...
            <TextInput
              ...
              value={transferEmail}
              onChangeText={(v) => { setTransferEmail(v); setTransferError(""); }}
              autoCapitalize="none"
            ...
            <View className="mt-5 flex-row gap-2">
              <Pressable
                onPress={() => { setTransferOpen(false); setTransferError(""); }}
