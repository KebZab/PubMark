            ...
            return (
              ...
              >
                <div className="flex items-center gap-3">
                  <div
                    className={`w-9 h-9 rounded-xl flex items-center justify-center ${cfg.color.split(" ")[0]}`}
                  >
              ...
              >
                ...
                >
                  <div className="flex items-start gap-3">
                    <div
                      className={`mt-0.5 w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0 ${cfg.color.split(" ")[0]}`}
                    >
                      <Icon className={`w-5 h-5 ${cfg.color.split(" ")[1]}`} />
                    </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <div className="w-full max-w-sm bg-white rounded-2xl shadow-2xl p-6">
            ...
            <p className="text-xs text-gray-400 text-center mb-6">
              This will remove it from the archive.
            </p>
