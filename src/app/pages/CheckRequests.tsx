...
export function CheckRequests() {
  ...
  const [requests, setRequests] = useState<OfficerCheckRequest[]>([]);
            ...
            <div className="flex-1 overflow-y-auto p-3 space-y-2">
              {requests.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full text-center py-12">
                  ...
                  <p className="text-xs text-gray-400 mt-1">Click a stall on the map to create one</p>
                </div>
              ) : (
                requests.map((req) => {
                    ...
                    >
                      <div className="flex items-start justify-between gap-2 mb-2">
                        <div className="flex-1 min-w-0">
                          <p className="text-sm font-semibold text-gray-900 truncate">{req.stallName}</p>
