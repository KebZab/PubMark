...
export function Login() {
  ...
  const DEMO_ACCOUNTS = [
    { label: "Super Admin", email: "superadmin@pubmark.com", password: "super123", color: "bg-purple-100 text-purple-700" },
    { label: "Admin", email: "admin@pubmark.com", password: "admin123", color: "bg-blue-100 text-blue-700" },
    { label: "Vendor", email: "juan@example.com", password: "user123", color: "bg-teal-100 text-teal-700" },
    { label: "Officer", email: "officer@pubmark.com", password: "officer123", color: "bg-amber-100 text-amber-700" },
  ];
        ...
        <div className="hidden lg:flex bg-gradient-to-br from-[#0d9488] to-[#0f766e] p-12 flex-col justify-between relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-3xl font-bold text-white leading-snug mb-4">
              Manage Your<br />Public Market<br />
              <span className="text-teal-200">Digitally.</span>
            </h2>
            <p className="text-teal-100 text-sm leading-relaxed">
              Complete marketplace management — interactive maps, stall applications, vendor management, violation tracking, and real-time analytics.
            </p>
          </div>

          {/* Stats */}
          <div className="relative z-10 grid grid-cols-3 gap-4">
            {[{ n: "5", l: "User Roles" }, { n: "500+", l: "Stalls" }, { n: "24/7", l: "Monitoring" }].map((s) => (
